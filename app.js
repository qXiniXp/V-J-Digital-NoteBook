...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const showDetails = (id) => {
        ...
        measurementsContainer.innerHTML = `
            ...
            <button id="exportBtn" class="primary" style="margin-top:0.75rem;">Export u Excel</button>
        ...
        document.getElementById('exportBtn').onclick = () => {
            ...
            a.href = url;
            a.download = `${measurement.projectName}.csv`;
            a.click();
    ...
    function updateDashboard() {
        ...
        document.getElementById('timeFilter').onchange = updateDashboard;
    }
